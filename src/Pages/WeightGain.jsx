  ...
  return (
    <>
      ...
      <section className="px-20 pt-20 pb-10 flex gap-x-10 items-center justify-evenly">
        <div className="w-1/2 flex flex-col gap-y-10">
          ...
          <p className="w-5/6 text-neutral-700 text-l">
            Adding calorie-dense, nutritious meals and snacks to your daily routine can make reaching your weight gain goals easier and more enjoyable. Here are some tasty options that pack a punch in both calories and quality nutrition—perfect for fueling muscle growth and supporting overall health. Remember, consistency is key, so find meals and snacks you love and incorporate them regularly!
            <br />
          </p>
          <ul>
            <b>Breakfast:</b>
            <li>Oatmeal made with whole milk, topped with nuts, seeds, and honey</li>
            <li>Smoothie with banana, peanut butter, protein powder, and full-fat yogurt</li>
          </ul>
          ...
          <ul>
            <b>Lunch/Dinner:</b>
            <li>Grilled chicken or salmon with quinoa and roasted vegetables with olive oil</li>
            <li>Whole grain pasta with a creamy avocado sauce and lean ground turkey</li>
            <li>Stir-fried tofu or beef with brown rice and mixed vegetables</li>
          </ul>
        </div>
      ...
      />
       ...
       <section className="px-20 pt-20 pb-10 flex gap-x-10 items-center justify-evenly">
        <div className="flex flex-col gap-y-5">
            <h1 className="text-5xl w-5/6">Ready to Take the <span className="text-primary">Next Step?</span> Start Your Healthy Weight Gain Journey Now</h1>
            <div className="flex gap-x-10 items-center justify-evenly">
                
                <p className="w-5/6 text-neutral-700 text-l w-6/8">Don’t wait to achieve the body and health you deserve. With CalQulate’s personalized tools, expert guidance, and easy-to-use trackers, you have everything you need to start gaining weight the right way. Whether you’re new to weight gain or looking to improve your progress, take control today by setting your goals, calculating your calorie surplus, and making informed nutritional choices. Your journey to a stronger, healthier you begins with one step — and CalQulate is here to support you every step of the way.</p>
                <Link className="cursor-pointer" to={"/"}><button className="rounded-full bg-primary font-bold text-white px-10 py-5">Calculate My Surplus</button></Link>
            </div>
